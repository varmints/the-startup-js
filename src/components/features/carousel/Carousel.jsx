        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="mb-12 flex flex-col items-center justify-between gap-6 md:flex-row md:items-end">
            <div className="space-y-3">
              <SectionHeading>Zagłęb się w szczegóły</SectionHeading>
              <SectionSubheading>
                Czy chcesz się jeszcze czymś pochwalić? Z czego jesteś dumny? Co
                Cię wyróżnia? Pokaż to tutaj!
              </SectionSubheading>
            </div>
...
const features = [
  {
    id: 1,
    Icon: FiArrowUp,
    title: "Szybkie i dokładne raportowanie",
    description:
