    ...
    <div className="col-span-2 h-fit sm:h-[209px]">
      <Card>
        <div className="relative z-20">
          <CalloutChip>Objaśnienie #4</CalloutChip>
          <p className="mb-1.5 text-2xl">Porozmawiajmy o integracjach</p>
          <p className="max-w-sm text-zinc-400">
            Jeśli łączysz się z narzędziami, które ludzie już znają i używają,
            pochwal się tym!
          </p>
        </div>
