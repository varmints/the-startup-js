    ...
    <div className="col-span-2 h-[375px] md:col-span-1">
      <Card>
        <div className="mx-auto w-fit">
          <CalloutChip>Objaśnienie #2</CalloutChip>
        </div>
        <p className="mb-1.5 text-center text-2xl">Podkreśl coś fajnego</p>
        <p className="mb-6 text-center text-zinc-400">Krótkie i słodkie.</p>
        <BubbleButton className="mx-auto">Wezwanie do działania</BubbleButton>
